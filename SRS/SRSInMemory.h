...
class SRS_In_Memory {
 ...
 public:
  SRS_In_Memory(const char * index_path);
  virtual ~SRS_In_Memory();

  void build_index(long long n, int d, int m, char * ds_path);
  void build_index_from_data(long long n, int d, int m, T** datas);
  void build_index_in_memory(long long n, int d, int m, T** datas);
  void restore_index();
  template<typename X>
...
template<typename T>
SRS_In_Memory<T>::SRS_In_Memory(const char * index_path) {
...
template<typename T>
void SRS_In_Memory<T>::build_index_from_data(long long n, int d, int m, T** datas) {
  this->n = n;
  this->d = d;
  this->m = m;
  this->proj = new float[m * d];
  ...
  this->raw_data = new Raw_data<T>(n, d, datas);
  ...
  //read data
  for(;point_cnt < n;point_cnt++){
    T* data = datas[point_cnt];
...
template<typename T>
void SRS_In_Memory<T>::build_index_in_memory(long long n, int d, int m, T** datas) {
  this->n = n;
  this->d = d;
  this->m = m;
  this->proj = new float[m * d];
